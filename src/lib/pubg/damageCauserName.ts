// PUBG 공식 에셋 저장소의 damageCauserName 사전을 그대로 옮겼다.
// 출처: https://github.com/pubg/api-assets/blob/master/dictionaries/telemetry/damageCauserName.json
//
// 저장소에 포함한 이유: 이 사전은 2024-10 이후 갱신되지 않는다.
// 런타임에 GitHub을 부르면 의존만 늘고 얻는 게 없다.
//
// 갱신이 멈춘 탓에 최신 무기(RPD 등)가 빠져 있다. 반드시 폴백을 거칠 것.
export const DAMAGE_CAUSER_NAME: Record<string, string> = {
